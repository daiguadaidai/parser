...
function build_importer()
{
    ...
    rm -rf $importer
    GO111MODULE=on go build -o $importer github.com/daiguadaidai/tidb/cmd/importer
}
...
function build_tidb_server()
{
    ...
    rm -rf $tidb_server
    GO111MODULE=on go build -race -o $tidb_server github.com/daiguadaidai/tidb/tidb-server
}
