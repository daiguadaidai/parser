...
import (
	...
	"github.com/daiguadaidai/tidb/util/schemautil"
	"github.com/daiguadaidai/tidb/util/set"
...
func (d *ddl) getModifiableColumnJob(ctx sessionctx.Context, ident ast.Ident, originalColName model.CIStr,
	...
	newCol := table.ToColumn(&model.ColumnInfo{
		ID: col.ID,
		// We use this PR(https://github.com/daiguadaidai/tidb/pull/6274) as the dividing line to define whether it is a new version or an old version TiDB.
