...
1. Before starting to write a design document, please [create a new issue](https://github.com/daiguadaidai/tidb/issues/new/choose) for tracing the process of your design.
