...
import (
	...
	"github.com/daiguadaidai/tidb/executor"
	...
	"github.com/daiguadaidai/tidb/util/testutil"
...
func (s *seqTestSuite) TestEarlyClose(c *C) {
	...
	gofail.Enable("github.com/daiguadaidai/tidb/store/tikv/handleTaskOnceError", `return(true)`)
	defer gofail.Disable("github.com/daiguadaidai/tidb/store/tikv/handleTaskOnceError")
...
func (s *seqTestSuite) TestShow(c *C) {
	...
	row := result.Rows()[0]
	// For issue https://github.com/daiguadaidai/tidb/issues/1061
	...
	// For issue https://github.com/daiguadaidai/tidb/issues/1918
	...
	// for issue https://github.com/daiguadaidai/tidb/issues/4224
	...
	// for issue https://github.com/daiguadaidai/tidb/issues/3747
	...
	// for issue https://github.com/daiguadaidai/tidb/issues/4678
	...
	// for issue https://github.com/daiguadaidai/tidb/issues/4411
	...
	// for issue https://github.com/daiguadaidai/tidb/issues/4424
	...
	// for issue https://github.com/daiguadaidai/tidb/issues/4425
	tk.MustExec("drop table if exists show_test")
	testSQL = `create table show_test(
	...
	// for issue https://github.com/daiguadaidai/tidb/issues/4426
	tk.MustExec("drop table if exists show_test")
	testSQL = `create table show_test(
		a bit(1),
...
func (s *seqTestSuite) TestParallelHashAggClose(c *C) {
	...
	// Goroutine should not leak when error happen.
	gofail.Enable("github.com/daiguadaidai/tidb/executor/parallelHashAggError", `return(true)`)
	defer gofail.Disable("github.com/daiguadaidai/tidb/executor/parallelHashAggError")
	ctx := context.Background()
...
func (s *seqTestSuite) TestUnparallelHashAggClose(c *C) {
	...
	// Goroutine should not leak when error happen.
	gofail.Enable("github.com/daiguadaidai/tidb/executor/unparallelHashAggError", `return(true)`)
	defer gofail.Disable("github.com/daiguadaidai/tidb/executor/unparallelHashAggError")
	ctx := context.Background()
