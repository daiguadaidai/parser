...
import (
	...
	"github.com/daiguadaidai/tidb/planner/core"
...
func (s *testSuite2) TestMultipleTableUpdate(c *C) {
	...
	// fix https://github.com/daiguadaidai/tidb/issues/369
	testSQL := `
	...
	// fix https://github.com/daiguadaidai/tidb/issues/376
	...
	// test https://github.com/daiguadaidai/tidb/issues/3604
...
// TestIssue4067 Test issue https://github.com/daiguadaidai/tidb/issues/4067
...
func (s *testSuite2) TestAutoIDInRetry(c *C) {
	...
	gofail.Enable("github.com/daiguadaidai/tidb/session/mockCommitRetryForAutoID", `return(true)`)
	tk.MustExec("commit")
	gofail.Disable("github.com/daiguadaidai/tidb/session/mockCommitRetryForAutoID")
