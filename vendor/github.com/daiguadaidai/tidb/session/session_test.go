...
import (
	...
	"github.com/daiguadaidai/tidb/privilege/privileges"
	"github.com/daiguadaidai/tidb/session"
	"github.com/daiguadaidai/tidb/sessionctx"
	"github.com/daiguadaidai/tidb/sessionctx/binloginfo"
	...
	"github.com/daiguadaidai/tidb/table/tables"
...
func (s *testSessionSuite) TestAutoIncrementWithRetry(c *C) {
	// test for https://github.com/daiguadaidai/tidb/issues/827
...
func (s *testSessionSuite) TestResultType(c *C) {
	// Testcase for https://github.com/daiguadaidai/tidb/issues/325
	tk := testkit.NewTestKitWithInit(c, s.store)
...
func (s *testSessionSuite) TestRetry(c *C) {
	// For https://github.com/daiguadaidai/tidb/issues/571
	tk := testkit.NewTestKitWithInit(c, s.store)
...
func (s *testSessionSuite) TestParser(c *C) {
	...
	// test for https://github.com/daiguadaidai/tidb/pull/177
...
func (s *testSessionSuite) TestOnDuplicate(c *C) {
	...
	// test for https://github.com/daiguadaidai/tidb/pull/454
	tk.MustExec("drop table if exists t")
	tk.MustExec("drop table if exists t1")
...
func (s *testSessionSuite) TestReplace(c *C) {
	...
	// test for https://github.com/daiguadaidai/tidb/pull/456
	tk.MustExec("drop table if exists t")
	tk.MustExec("drop table if exists t1")
	tk.MustExec("create table t1 (c1 int, c2 int, c3 int);")
...
func (s *testSessionSuite) TestDelete(c *C) {
	// test for https://github.com/daiguadaidai/tidb/pull/1135
...
func (s *testSessionSuite) TestUnique(c *C) {
	// test for https://github.com/daiguadaidai/tidb/pull/461
	...
	// Test for https://github.com/daiguadaidai/tidb/issues/463
...
func (s *testSessionSuite) TestSet(c *C) {
	// Test for https://github.com/daiguadaidai/tidb/issues/1114
...
func (s *testSchemaSuite) TestRetrySchemaChange(c *C) {
	...
	// See https://github.com/daiguadaidai/tidb/pull/5202
