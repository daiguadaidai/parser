...
func (s *testCommitterSuite) TestFailCommitPrimaryRpcErrors(c *C) {
	gofail.Enable("github.com/daiguadaidai/tidb/store/mockstore/mocktikv/rpcCommitResult", `return("timeout")`)
	defer gofail.Disable("github.com/daiguadaidai/tidb/store/mockstore/mocktikv/rpcCommitResult")
...
func (s *testCommitterSuite) TestFailCommitPrimaryRegionError(c *C) {
	gofail.Enable("github.com/daiguadaidai/tidb/store/mockstore/mocktikv/rpcCommitResult", `return("notLeader")`)
	defer gofail.Disable("github.com/daiguadaidai/tidb/store/mockstore/mocktikv/rpcCommitResult")
...
func (s *testCommitterSuite) TestFailCommitPrimaryRPCErrorThenRegionError(c *C) {
	gofail.Enable("github.com/daiguadaidai/tidb/store/mockstore/mocktikv/rpcCommitResult", `1*return("timeout")->return("notLeader")`)
	defer gofail.Disable("github.com/daiguadaidai/tidb/store/mockstore/mocktikv/rpcCommitResult")
...
func (s *testCommitterSuite) TestFailCommitPrimaryKeyError(c *C) {
	gofail.Enable("github.com/daiguadaidai/tidb/store/mockstore/mocktikv/rpcCommitResult", `return("keyError")`)
	defer gofail.Disable("github.com/daiguadaidai/tidb/store/mockstore/mocktikv/rpcCommitResult")
	// Ensure it returns the original error without wrapped to ErrResultUndetermined
...
func (s *testCommitterSuite) TestFailCommitTimeout(c *C) {
	gofail.Enable("github.com/daiguadaidai/tidb/store/mockstore/mocktikv/rpcCommitTimeout", `return(true)`)
	defer gofail.Disable("github.com/daiguadaidai/tidb/store/mockstore/mocktikv/rpcCommitTimeout")
	txn := s.begin(c)
