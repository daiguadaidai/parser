...
func (s *testSQLSuite) TestFailBusyServerCop(c *C) {
	...
	gofail.Enable("github.com/daiguadaidai/tidb/store/mockstore/mocktikv/rpcServerBusy", `return(true)`)
	go func() {
		defer wg.Done()
		time.Sleep(time.Millisecond * 100)
		gofail.Disable("github.com/daiguadaidai/tidb/store/mockstore/mocktikv/rpcServerBusy")
	}()
