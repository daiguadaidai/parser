...
func (s *testTableCodecSuite) TestDecodeBadDecical(c *C) {
	gofail.Enable("github.com/daiguadaidai/tidb/util/codec/errorInDecodeDecimal", `return(true)`)
	defer gofail.Disable("github.com/daiguadaidai/tidb/util/codec/errorInDecodeDecimal")
